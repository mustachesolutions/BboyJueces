        ...
        <form data-ajax="false">
            <div data-role="page" id="pagina1" >
                ...
                <div data-role="header" 
                    ...
                    <a onclick="goTo('WebOUR/dynamics.jsp?m=1')" data-role="button" data-theme="b" data-icon="refresh">Cargar</a>
                   ...
                   <a href="#popupMenu" data-rel="popup" data-role="button" data-inline="true" data-transition="flip">Opciones</a>   
                    ...
                    <li><a name="e" onclick="goTo('WebOUR/resultadoCategoria.jsp')">Ganador de categoria</a></li>
                    <li><a onclick="goTo('WebOUR/resultados-finales.jsp?batalla=<%=idBatalla%>')" >Resultados generales</a></li>
                   <li><a onclick="goTo('WebOUR/corregir.jsp')">Corregir</a></li>
                ...
                <div id="cuerpo" data-role="content" 
                     ...
                     data-ajax="false"
                     >
                    <h2 id="h2" style="color:<%=color%>;"><%=crew%></h2>     
                    <br>
