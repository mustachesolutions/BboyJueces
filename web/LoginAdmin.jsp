...
<jsp:useBean id="loginAdmin" scope="session" class="control.LoginAdmin"/>
<%String url = "";
    String usuario = "";
    String clave = "";
    String mensaje = "";
    mensaje=loginAdmin.getMensaje();
    if (request.getParameter("login") != null) {
        ...
        if (request.getParameter("usuario") != null) {
            ...
            if (request.getParameter("clave") != null) {
                ...
                loginAdmin.setUsername(usuario);
                loginAdmin.setPassword(clave);

                if (loginAdmin.validarCredencialesUsuario()) {

                    HttpSession sesionOk = request.getSession();
                     sesionOk.setMaxInactiveInterval(86400);
                    sesionOk.setAttribute(Sesiones.sesionAdmin, usuario);
